    ...
    return (
        <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
            ...
            <Typography variant="body2" color="text.secondary" paragraph>
                {t('Ballot tokens allow voters to access their unique voting page. Share these links individually or export all as CSV.')}
            </Typography>

            <Alert severity="warning" sx={{ mb: 3 }}>
                {t('Important: Each token should be shared with exactly one person. Tokens are unique to each voter and should not be reused or shared publicly.')}
            </Alert>
            ...
            {loading ? (
                ...
                <Alert severity="info">
                    {t('No ballot tokens have been created yet.')}
                </Alert>
            ) : (
                            ...
                            <div key={token.id}>
                                ...
                                >
                                    <ListItemText
                                        ...
                                        secondary={
                                            token.converted_at
                                                ? t('Used on {{date}}', { date: new Date(token.converted_at).toLocaleString() })
                                                : t('Not used yet')
                                        }
